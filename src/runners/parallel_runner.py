...
class ParallelRunner:
    ...
    def __init__(self, args, logger):
        ...
        #                     for worker_conn in self.worker_conns] --origin
    ...
    def run(self, test_mode=False, filename = "test.txt",episode=0):
        self.reset()
        ...
        while True:
            ...
            actions = self.mac.select_actions(self.batch, t_ep=self.t, t_env=episode, bs=envs_not_terminated, test_mode=test_mode)
        ...
        #     self._log(cur_returns, cur_stats, log_prefix,filename,episode)
    ...
    def _log(self, returns, stats, prefix,filename="test.txt",episode=0):
